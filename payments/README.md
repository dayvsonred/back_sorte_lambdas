...
terraform plan -var "aws_region=us-east-1" -var "api_id=rm0t2sapef" -var "stage_name=$default" -var "lambda_zip=../lambda.zip" -var "stripe_secret_key=sk_live_xxx" -var "event_source_name=aws.partner/stripe.com/ed_61U7OMm8X8a9j7pji16U6BTHIq9PLmkSEfvbhl6fgPIG" -var "env=prod"

terraform apply -var "aws_region=us-east-1" -var "api_id=rm0t2sapef" -var "stage_name=$default" -var "lambda_zip=../lambda.zip" -var "stripe_secret_key=sk_live_xxx" -var "event_source_name=aws.partner/stripe.com/ed_61U7OMm8X8a9j7pji16U6BTHIq9PLmkSEfvbhl6fgPIG" -var "env=prod"
```
